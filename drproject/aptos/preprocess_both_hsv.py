...
def preprocess_dataset_1():
    ...
    PROCESS_DIR = Path('/src/project/aptos2019-blindness-detection/data/preprocessed/hsv')
...
def preprocess_dataset_2():
    ...
    PROCESS_DIR = Path('/src/project/aptos2019-blindness-detection/data/preprocessed/hsv/diabetic-retinopathy-detection')
    PRO_TRAIN_DIR = PROCESS_DIR / 'train_images'
    PRO_TEST_DIR = PROCESS_DIR / 'test_images'
