...
def preprocess_dataset_1():
    ...
    PROCESS_DIR = Path('/src/project/aptos2019-blindness-detection/data/preprocessed/greyscale')
...
def preprocess_dataset_2():
    DATA_DIR = Path('/src/project/aptos2019-blindness-detection/data/raw/diabetic-retinopathy-detection')
    ...
    PROCESS_DIR = Path('/src/project/aptos2019-blindness-detection/data/preprocessed/greyscale/diabetic-retinopathy-detection')
    PRO_TRAIN_DIR = PROCESS_DIR / 'train_images'
    PRO_TEST_DIR = PROCESS_DIR / 'test_images'
